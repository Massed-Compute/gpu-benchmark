...
[Llama 3 70B Instruct Agreement](./images/meta-llama_Meta-Llama-3-70B-Instruct_agreement.png)
...
**$shard** The number of GPUs to spread the model across. EX: 4xA6000 Instance: `shard=4`
...
![RTX A6000](./images/4xA6000-llama3-70b.png)

**L40**
4xL40 Instance: **$3.96/hr**
![L40](./images/4xL40-llama3-70b.png)

**A100 PCIe**
2xA100 PCIe Instance: **$3.44/hr**
![A100 PCIe](./images/2xA100PCIe-llama3-70b.png)

**A100 SXM4**
2xA100 SXM4 Instance: **N/A** (We partitioned 2 GPUs for this test but only sell 8 GPU bare metal)
![A100 SXM4](./images/2xA100SXM4-llama3-70b.png)

**H100 PCIe**
2xH100 PCIe Instance: **$5.98/hr**
![H100 PCIe](./images/2xH100PCIe-llama3-70b.png)
